...
export default function Breadcrumb(probs: any) {
  ...
  return (
    ...
    <div className='breadcrumb-style'>
      ...
      <BSBreadcrumb listProps={{
          className: `my-0  align-items-center breadcrumb-m ${darkMode ? "dark-mode-body" : "light-mode-body"
            }`,
        }}>
        ...
        {breadcrumbs && breadcrumbs.map((br: any, i: number) => {
          return i > 1 && i < 4 && <BSBreadcrumb.Item key={i}
            ...
            linkProps={{ className: `text-decoration-none ${darkMode ? "dark-mode-body" : "light-mode-body"
          }`, }}
