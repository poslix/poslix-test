            ...
            if (repo.status === true) {
                ...
                if (locationPermission(repo.data.locs, shopId) != -1) {
                    ...
                    if (subType == 'insert_category') {
                        ...
                        con.query(`INSERT INTO categories(name,location_id,parent_id,tax_id,never_tax,created_by,description) VALUES (?,?,?,?,?,?,?)`,
                    ...
                    if (subType == 'insert_brand') {
                        ...
                        con.query(`INSERT INTO brands(name,location_id,tax_id,never_tax,created_by,description) VALUES (?,?,?,?,?,?)`,
