...
import { Data, ITailoringCustom, ITokenVerfy } from '../../../models/common-model';
import { increaseQtySold, locationPermission, redirection, verifayTokens } from '../checkUtils';
          ...
          if (subType == 'newPosSale') {
            ...
            if (details.isReturn > 0) {
              ...
              if (req.body.editing) {
                await con
                  .promise()
                  .query(`DELETE FROM transaction_payments WHERE transaction_id = ?`, [
                    transaction_id,
                  ])
                  .then((rows: any, fields: any) => {})
                  .catch();
