      ...
      if (repo.status === true) {
        ...
        if (locationPermission(repo.data.locs, shopId) != -1) {
          ...
          if (subType == 'tailoringadd') {
            ...
            con.query(
              `INSERT INTO tailoring_type(location_id,name,multiple_value,created_by,extras) VALUES (?,?,?,?,?)`,
          ...
          if (subType == 'addExtras') {
            ...
            con.query(
              `INSERT INTO tailoring_extra(location_id,name,is_required,items,created_at) VALUES (?,?,?,?,?)`,
