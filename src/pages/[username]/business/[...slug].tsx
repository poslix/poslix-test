                    ...
                    <div className="row">
                      <div className="col-md-12 col-lg-6 col-cm-12">
                        ...
                        <div className="form-group2">
                          ...
                          />
                          {errorForm.mobile && (
                            <p className="p-1 h6 text-danger ">Enter Mobile Number</p>
                          )}
                        </div>
                        <div className="form-group2">
                          <label>
                          ...
                          />
                          {errorForm.email && (
                            <p className="p-1 h6 text-danger ">Enter Email name</p>
                          )}
                        </div>
                        <div className="form-group">
                          ...
                          <Select
                            ...
                            value={busniessType.filter((f: any) => {
                              return f.value == formObj.business_type;
                            })}
                            onChange={(itm) => {
                              setFormObj({ ...formObj, business_type: itm!.value });
                            }}
                          />
                        </div>
                        <div className="form-group">
                          ...
                          <Select
                            ...
                            value={currencies.filter((f: any) => {
                              return f.value == formObj.country;
                            })}
                            onChange={(itm) => {
                              setFormObj({ ...formObj, country: itm!.value });
                            }}
                          />
                        </div>
                      ...
                      <div className="col-md-6 d-lg-block d-sm-none d-md-none">
                        <img
                          style={{ width: '100%' }}
                          src={
                            'https://static.vecteezy.com/system/resources/previews/012/024/324/original/a-person-using-a-smartphone-to-fill-out-a-registration-form-registration-register-fill-in-personal-data-use-the-application-vector.jpg'
                          }
                        />
                      </div>
                    </div>
