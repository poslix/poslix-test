  ...
  return (
    ...
    <div className="card" style={{ width: '40%', marginLeft: '80px' }}>
      ...
      <div className="card-body">
        ...
        <MenuOrdersFooter selectedHold={selectedHold} orderEditDetails={orderEditDetails} shopId={shopId} details={{ taxRate, customerId: customer?.value, totalAmount, isReturn: isOrderEdit }} holdObj={{ orders, quantity, name: 'noset' }} />
      </div>
      {/* end card body */}
    </div >
  );
