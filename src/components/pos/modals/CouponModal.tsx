					...
					<div className="poslix-modal" style={{ minWidth: "500px" }}>
						<div className="modal-content">
							...
							<div className="form-group2">
								...
								<input type="text" className="form-control" value={couponText} min={0} step={0.1}
							...
							<div className="modal-footer pt-2">
								{couponText.length > 0 && (
									<button type="button" onClick={() => console.log(true)} className="btn  fs-15 fs-sm-20 bg-success mx-3" style={{ color: 'white' }} >APPLY COUPON</button>
								)}
								<button type="button" onClick={() => { openDialog(false) }} className="btn  fs-15 fs-sm-20 bg-danger" style={{ color: 'white' }} > <i className="ri-close-line me-1 align-middle" /> Close</button>
							</div>
						</div>
					</div>
				</DialogContent >
