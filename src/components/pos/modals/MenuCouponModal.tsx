          ...
          <div className="poslix-modal" style={{ minWidth: '500px' }}>
            <div className="modal-content">
              <div className="modal-body">
                <ul className="nav nav-pills arrow-navtabs nav-success mb-3" role="tablist">
                ...
                <div className="tab-content text-muted">
                  {selectdTab == 'hold' ? (
                    <div className="tab-pane active" id="arrow-hold" role="tabpanel">
                      <div className="table-responsive mt-2">
                        <table className="table table-centered table-hover align-middle  mb-0">
                          <thead className="text-muted order-head">
                            <tr>
                              <th scope="col" style={{ borderRadius: '12px 0px 0px 10px' }}>
                                #
                              </th>
                              <th scope="col">Hold Name</th>
                              <th scope="col" style={{ borderRadius: '0px 10px 10px 0px' }}>
                                Action
                              </th>
                            </tr>
                          </thead>
                                  ...
                                  if (hi.location_id == shopId) {
                                    return (
                                      <tr key={i}>
                                        ...
                                        <td>
                                          ({hi.name})
                                          <span style={{ color: '#d7d5d5' }}> [{hi.length}]</span>
                                        </td>
                                        <td>
                                          <a
                                            href="#"
